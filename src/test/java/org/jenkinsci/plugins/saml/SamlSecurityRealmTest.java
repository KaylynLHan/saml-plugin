...
public class SamlSecurityRealmTest {
    ...
    public void testGetters() throws IOException {
        ...
        assertEquals(new SamlAdvancedConfiguration(null,null,null, null, null, null).toString().contains("SamlAdvancedConfiguration"),true);
        assertEquals(new SamlAdvancedConfiguration(true,null,null, null, null, null).toString().contains("SamlAdvancedConfiguration"),true);
        assertEquals(new SamlAdvancedConfiguration(true,"","", "", 1, null).toString().contains("SamlAdvancedConfiguration"),true);
